...
Com os dados agrupados com as três unidades de tempo citadas, houve a remoção dos dias com menos que 22 medições(~90\% das 24 máximas), e dos anos com menos de 90\% de dias válidos. Valor de 90\% foi escolhido anteriormente à análise para evitar enviésamentos, como \textit{cherry-picking}, porém algumas análises menos sensíveis poderão usar anos válidos com taxa de 80\% de dias válidos. Catalogação dos anos válidos visível na imagem \ref{fig:anos}.
...
\subsection{Estatistica Descritiva}
