...
Por outro lado, o indicador de precipitação média diária para mesma cobertura apresenta inclinação anual estimada de redução de 0.0678mm diários. Dado o valor p de 0.0062, também se identifica inclinação estatisticamente significante, com intervalo de confiança entre -0.2315 mm e -1.1236 mm, não incluindo 0, formando outra aceitação da hipótese alternativa.
