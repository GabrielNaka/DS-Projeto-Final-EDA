...
\abstract{Esse trabalho busca realizar uma análise exploratória(EDA) para estudar possíveis mudanças climáticas significativas de temperatura e condições de precipitação durante o período de 2000-2026 no Brasil, assim como o impacto dessa situação para construção de infraestrutura}
...
\keywords{EDA, mudança climática, big data, INMET}
